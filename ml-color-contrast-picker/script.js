...
// inital input 0 & 1
// to train :
// click the right color white/black according to the background
// after few trainings clock print to get the output data in console
// copy-paste this array to replace the initial data
net.train(data);
